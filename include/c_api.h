...
ORTKI_API(ortki::OrtKITensor*) make_tensor(void *buffer, DataType data_type, const int* shape, int shape_size);
ORTKI_API(void) tensor_dispose(ortki::OrtKITensor*);
ORTKI_API(DataType) tensor_data_type(ortki::OrtKITensor *tensor);
